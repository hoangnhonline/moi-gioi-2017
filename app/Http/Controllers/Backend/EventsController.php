    ...
    */
    public function store(Request $request)
    {
        ...
        if($dataArr['small_banner'] && $dataArr['small_name']){
            ...
            File::move(config('moigioi.upload_path').$dataArr['small_banner'], config('moigioi.upload_path').$destionation);
        ...
        if($dataArr['large_banner'] && $dataArr['large_name']){
            ...
            File::move(config('moigioi.upload_path').$dataArr['large_banner'], config('moigioi.upload_path').$destionation);
