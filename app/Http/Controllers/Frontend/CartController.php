...
class CartController extends Controller
{
    ...
    */
    ...
    public function order(Request $request)
    {
        ...
        if($email != ''){
            $emailArr = array_merge([$email], ['tundq.ipl@gmail.com', 'tundq@icare.center', 'hiepvv.ipl@gmail.com', 'lamhuong77@gmail.com', 'chamsoc@moigioi.vn', 'hoangnhonline@gmail.com']);
        }else{
            $emailArr = ['tundq.ipl@gmail.com', 'tundq@icare.center', 'hiepvv.ipl@gmail.com', 'lamhuong77@gmail.com', 'chamsoc@moigioi.vn', 'hoangnhonline@gmail.com'];
        }
        // send email
