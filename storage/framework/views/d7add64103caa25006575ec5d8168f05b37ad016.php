				...
				<div class="project-item">
					<div class="project-img">
					    <a href="<?php echo e(route('detail-project', [$value->slug])); ?>" title="<?php echo e($value->name); ?>">
					        <img src="<?php echo e($value->image_url ? Helper::showImageThumb($value->image_url, 3, '306x194') : URL::asset('public/admin/dist/img/no-image.jpg')); ?>" alt="<?php echo $value->name; ?>">
					    </a>
					</div>
