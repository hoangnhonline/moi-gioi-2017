         ...
         <li style="border-bottom:1px solid #ECECEC;margin-bottom:10px;">
            <div class="div_img_tt">
               <a href="#tin-tuc/sieu-do-thi-moi-cu-chi-va-ly-trinh-dai-lo-ven-song-sai-gon/109.html"><img
                  class="img_ttnb" src="<?php echo e(URL::asset('public/assets/files/sieu-do-thi-moi-cu-chi-1488096283.jpg')); ?>"
                  width="90" height="90"
         ...
         <li style="border-bottom:1px solid #ECECEC;margin-bottom:10px;">
            <div class="div_img_tt">
               <a href="#tin-tuc/bang-gia-dat-o-huyen-cu-chi-tphcm-20152019/108.html"><img
                  class="img_ttnb"
                  src="<?php echo e(URL::asset('public/assets/files/bang-gia-dat-o-huyen-cu-chi-tphcm-20152019-1478348748.jpg')); ?>"
                  width="90" height="90"
