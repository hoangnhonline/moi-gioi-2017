	    ...
	    <div class="block-utilities">
	    	...
	    	<div class="table-responsive">
		    	<table class="table table-bordered">
	    			<tr>
	    				<?php $i = 0; ?>
			    		<?php foreach($tienIchLists as $value): ?>
			    		<?php $i++; ?>
		    			
		    				<td><?php echo $value->name; ?> 
		    				<?php if(in_array($value->id, $tienIch)): ?> 
						...
						<div class="news-with-region-item clearfix">
							...
							<div class="news-with-region-content">
								<div class="news-with-region-img">
									<a  href="<?php echo e(route('chi-tiet', [$product->slug_loai, $product->slug, $product->id])); ?>"><img  title="<?php echo $product->title; ?>" src="<?php echo e($product->image_urls ? Helper::showImageThumb($product->image_urls) : URL::asset('public/admin/dist/img/no-image.jpg')); ?>" alt="<?php echo $product->title; ?>" ></a>
								</div>
