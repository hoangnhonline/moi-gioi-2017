                        ...
                        <table class="table table-bordered" id="table-list-data">
                            ...
                            <tbody>
                                ...
                                <tr id="row-{{ $item->id }}">
                                    ...
                                    <td>
                                      <img class="img-thumbnail lazy" width="100" data-original="{{ $item->image_url ? Helper::showImage($item->image_url) : URL::asset('admin/dist/img/no-image.jpg') }}" alt="Nổi bật" title="Nổi bật" />
                                    </td>
                                    <td>
