	...
	<div class="block block-title">
		<ul class="nav nav-tabs nav-tabs-langding" id="nav-tabs-langding" role="tablist">
			...
			@if(in_array(1, $tabSelected))
				<li role="presentation" style="width: 100px;" @if($tab_id == 1) class="active"  @endif>
					<a href="#gioi-thieu" >
						<i class="icon">
			...
			@if(in_array(2, $tabSelected))
				<li role="presentation" style="width: 100px;" @if($tab_id == 2) class="active" @endif>
					<a href="#vi-tri" >
						<i class="icon">
			...
			@if(in_array(3, $tabSelected))
				<li role="presentation" style="width: 100px;" @if($tab_id == 3) class="active" @endif>
					<a href="#tien-ich" >
						<i class="icon">
			...
			@endif
			@if(in_array(4, $tabSelected))
				<li role="presentation" style="width: 100px;" @if($tab_id == 4) class="active" @endif>
					<a href="#thiet-ke" >
						<i class="icon">
			...
			@if(in_array(5, $tabSelected))
				<li role="presentation" style="width: 100px;" @if($tab_id == 5) class="active" @endif>
					<a href="#thanh-toan" >
						<i class="icon">
			...
			@if(in_array(6, $tabSelected))
				<li role="presentation" style="width: 100px;" @if($tab_id == 6) class="active" @endif>
			...
			@if(in_array(7, $tabSelected))
				<li role="presentation" style="width: 100px;" @if($tab_id == 7) class="active" @endif>
					<a href="#lien-he" >
						<i class="icon">
				...
				<div role="tabpanel" class="tab-pane fade in active" id="About">
					@if($detailTab)
						...
						<?php
							...
							$tabName = $arrTabName[$detail->tab_id];
						?>

						<div class="page-block" id="{{ $tabName }}">
							<h2 class="page-title">{{ $detail->title }}</h2>
							<div class="page-content editor-content">
								<?php
								echo preg_replace('/(\<img[^>]+)(style\=\"[^\"]+\")([^>]+)(>)/', '${1}${3}${4}', $detail->content);
								?>
							</div>
						</div>
						@endforeach
...
@section('css_page')
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('public/assets/css/page/detail-project.css') }}">
@endsection